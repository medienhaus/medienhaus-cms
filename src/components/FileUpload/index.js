    ...
    <>
      ...
      {selectedFile && (
        <>
          ...
          <textarea rows="3" placeholder="please describe the image with some words to enable visually impaired website visitors to comprehend what’s being shown here" />
