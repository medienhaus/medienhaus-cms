  ...
  if (submitted) {
    return (
      <section>
        ...
        <p><Trans t={t} i18nKey="submittedMessage">We are collecting your feedback and will evaluate it after the Rundgang. If you need technical help with entering your contributions, please reach out via the <NavLink to="/support">/support</NavLink> form.</Trans></p>
      </section>
    )
  }
  return (
