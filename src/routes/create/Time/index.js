      ...
      {isUIVisible && (
        <>
          <div className="timedate">
            ...
            <div>
              <input type="date" id="start-date" min="2023-07-21" max="2023-07-23" name="start-date" value={startDate} onChange={(e) => setStartDate(e.target.value)} />
          ...
          <div className="timedate">
            ...
            <div>
              <input type="date" id="end-date" name="end-date" min={startDate || '2023-07-21'} max="2023-07-23" value={endDate} onChange={(e) => setEndDate(e.target.value)} />
