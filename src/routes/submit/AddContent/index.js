  ...
  return (
    <div className="add">
      {isPlusButton
        ...
        : (
          <>
            <select name="content-select" defaultValue="" id="content-select" onChange={(e) => setContentSelect(e.target.value)} onBlur={(e) => setContentSelect(e.target.value)}>
              <option value="" disabled>Select Content</option>
              <option value="none" disabled>--Text------------</option>
