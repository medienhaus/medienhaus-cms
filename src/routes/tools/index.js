  ...
  return (
    <form>
      <div>
        ...
        <select id="subject" name="subject" value={subject} onBlur={(e) => setSubject(e.target.value)}>
      ...
      <div>
        ...
        <select id="klasse" name="klasse" value={klasse} onBlur={(e) => setKlasse(e.target.value)}>
